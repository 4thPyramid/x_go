...
import 'package:x_go/features/profile/presentation/widgets/gender_bottom_sheet.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          onTap:(){
            GenderBottomSheet.showGenderBottomSheet(context: context, selectedGender: _selectedGender , onGenderSelected: onGenderSelected);
          },
          child: Container(
