...
import 'package:x_go/features/home/presentation/widgets/search_action_buttons.dart';
import 'package:x_go/features/home/presentation/widgets/search_loading_indicaror.dart';
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 12.w),
          Expanded(
            child: SearchInputField(searchManager: searchManager),
          ),
